...
- CECE EST MON RENDU DU DEVOIR SYSTEME D'EXPLOITION

## ETAPE DE MANIPULATION
- Language de choix: typescript
- env de choix: node.js

Pour installer les dependances j'utilise npm (node js version > 10 est necessaire)
```
